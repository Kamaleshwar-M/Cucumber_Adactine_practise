...
public void user_in_on_Adactine_Login_Page() {
	...
	@When("On Search Hotel PageUser should select details and click on search button")
	public void on_Search_Hotel_PageUser_should_select_details_and_click_on_search_button() {
	...
	public void on_Select_Hotel_page_User_should_select_Hotel_and_click_Continue() {
	...
	@When("User should Enter credit card details")
		public void user_should_Enter_credit_card_details(io.cucumber.datatable.DataTable dataTable) {
	...
	public void user_should_enter_cvvNum_and_click_BookNow_button() throws InterruptedException {
